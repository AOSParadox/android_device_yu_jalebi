...
$(INSTALLED_DTIMAGE_TARGET): $(DTBTOOL) $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr $(INSTALLED_KERNEL_TARGET)
	...
	$(hide) $(DTBTOOL) -o $(INSTALLED_DTIMAGE_TARGET) -s $(BOARD_KERNEL_PAGESIZE) -p out/target/product/jalebi/obj/KERNEL_OBJ/scripts/dtc/ out/target/product/jalebi/obj/KERNEL_OBJ/arch/arm/boot/dts/
	@echo "Made DT image: $@"
